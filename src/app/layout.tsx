...
export const metadata: Metadata = { title:"ModelOps — MLOps et deploiement de modeles IA en 48h", description:"ModelOps prend en charge tout le cycle de vie de vos modeles IA : fine-tuning, versioning, deploiement et monitoring en production, sans data scientist dedie." };
